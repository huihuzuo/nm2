var config = {
  ...
  service: {
    basicUrl: 'http://211.101.37.227:9316/',
    geocoding: 'http://211.101.37.227:9320/',
    geoserversde: 'http://211.101.37.227:9322/geoserver-sde/rest/action',
    // oldUrl: 'http://192.168.0.205:8082',
    oldUrl: 'http://211.101.37.237:9082',
    ...
    baseLayers: [
      {
        ...
        isDefault: true,
        layerType: "TileXYZ",
        layerUrl: 'http://211.101.37.251:6080/arcgis/rest/services/NeiMengGu/nmgcy20160622/MapServer/tile/{z}/{y}/{x}'
      },
      {
        layerName: 'panorama',
        isDefault: false,
        ...
        projection: 'EPSG:4326',
        layerType: "TileXYZ",
        layerUrl: 'http://211.101.37.251:6080/arcgis/rest/services/jiangxi/jxdxdem2018new/MapServer/tile/{z}/{y}/{x}'
      },
      {
        layerName: 'earth',
        isDefault: false,
