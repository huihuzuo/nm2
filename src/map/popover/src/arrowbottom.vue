...
<style lang="scss">
  ...
  .arrow-wrap{
    ...
    .arrow-bottom-wrap{
      ...
      background-color: #FFF;
      -webkit-box-shadow: 0px 1px 0px rgba(13, 5, 9, 0.15), 0px -1px 0 rgba(13, 5, 9, 0), 1px 1px 0 rgba(13, 5, 9, 0), -1px 0px 1px rgba(13, 5, 9, 0.15);
      box-shadow: 0px 1px 0px rgba(13, 5, 9, 0.15), 0px -1px 0 rgba(13, 5, 9, 0), 1px 1px 0 rgba(13, 5, 9, 0), -1px 0px 1px rgba(13, 5, 9, 0.15);
