      ...
      <div class="content">
        ...
        <div class="content-div" v-for="(item,index) in list" v-if="item"
          ...
          <div class="column-second">
            ...
            <div>
              <span>{{item.sxxfx | formatSxxfx}}, {{item.zh | formatZh}}</span>
            </div>
          </div>
          <div class="column-three">
            <div>
              <span>{{item.jamSpeed}}km/h</span>
            </div>
            <div>
          ...
          <div class="column-forth">
            <div>
              <span :style="getStyleForState(item)" class="numData">{{item.pubRunStatus | gaodeEventState}}</span>
              <span>公里</span>
            </div>
            <div>
